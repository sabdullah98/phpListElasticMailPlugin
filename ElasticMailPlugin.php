<?php
/**
 * ELasticmail plugin for phplist.
 *
 * This file is a part of Elasticmail Plugin.
 *
...
class ElasticMailPlugin extends phplistPlugin implements EmailSender
{
     ...
     *  Inherited variables
     */
    public $name = 'ElasticMail Plugin';
    public $authors = 'Syed Abdullah';
    public $description = 'Use Elasticmail to send emails';
    public $documentationUrl = 'https://elasticemail.com/support/http-api/send/';
    public $settings = array(
        'elasticmail_api_key' => array(
            'value' => '',
            'description' => 'Your API key',
            'type' => 'text',
            'allowempty' => false,
            'category' => 'Elasticmail',
        ),
    );
    ...
    {
        $this->coderoot = dirname(__FILE__) . '/' . 'ElasticMailPlugin' . '/';
        parent::__construct();
    ...
    /**
     * Send an email using the Elasticmail API.
     *
    ...
    public function send(PHPlistMailer $phpmailer, $headers, $body)
    {
        if ($this->connector === null) {
            ...
            $this->connector = new phpList\plugin\ElasticMailPlugin\Connector(getConfig('elasticmail_api_key'));
        }
